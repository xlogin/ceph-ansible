...
`rgw_multisite_endpoints` is a comma seperated list of the RGW endpoints in the format:<br/>
...
**Note:** if there is more than 1 RGW in the cluster, `rgw_multisite_endpoints` needs to be set just like it was set in the Primary Cluster
